...
<div style='float:right; margin-bottom:10px;'>
 <a class='my-links' href='${pageContext.request.contextPath}/portfolio/new_category'><i class='fa fa-plus'></i> New Category</a> 
</div>
 </div>	
...
<thead>
<tr> <th> S/N </th> <th> Title </th> <th>Date Added</th> <th> Action </th>  </tr>
<%int counter = 1; %>
</thead>
<tbody>
<c:forEach items="${categories}" var="category">  
<tr> <td> <%=counter++%> </td> <td><c:out value="${category.getTitle()}"/> </td> <td> </td>  <td> 
      <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class='fa fa-bars'></i>  </a>
                    <ul class="dropdown-menu alert-dropdown">  
                        <li>
                            <a href="${pageContext.request.contextPath}/portfolio/edit_category/${category.getId()}"><span class="label label-warning">Edit</span></a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/portfolio/delete_category/${category.getId()}"><span class="label label-danger">Delete</span></a>
                        </li> 
                    </ul>
                </li>
</td></tr>
