...
<div style='float:right; margin-bottom:10px;'>
 <a class='my-links' href='${pageContext.request.contextPath}/portfolio/new_platform'><i class='fa fa-plus'></i> New Platform </a> 
</div>
 </div>	
...
<tr> <td> <%=counter++%> </td> <td><c:out value="${platform.getTitle()}"/> </td> <td> </td>  <td> 
      <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class='fa fa-bars'></i>  </a>
                    <ul class="dropdown-menu alert-dropdown"> 
                       
                        <li>
                            <a href="${pageContext.request.contextPath}/portfolio/edit_platform/${platform.getId()}"><span class="label label-warning">Edit</span></a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/portfolio/delete_platform/${platform.getId()}"><span class="label label-danger">Delete</span></a>
                        </li> 
                    </ul>
                </li>
</td></tr>
