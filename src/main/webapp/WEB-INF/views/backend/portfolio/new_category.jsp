...
<body>
   <div class='container'>
   	...
   	<p class='head-title'> Category Properties </p>
   	<springForm:form action="${pageContext.request.contextPath}/portfolio/new_category/add"  commandName="category" method="post">
