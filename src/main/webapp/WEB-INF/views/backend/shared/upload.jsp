...
<h3 style='magin:15px;'>Select Pictures By Clicking on Them  

<!-- send marked images to a controller that will send them to the page that requested them
@Todo Simplify this further -->

<form action='${pageContext.request.contextPath}/shared/map_assets' method='post'>
<input type='hidden' name='moduleId' value='${moduleId}'/>
<input type='hidden' name='contentId' value='${contentId}'/>
<input type='hidden' name='request_url' value='${request_url}'/>
<input type='hidden' id='assets' name='assets'/>
 <button type='submit' id='submit_mapping' class='btn btn-primary' onclick='fill_selected_assets(this)' style='float:right;'> Done <i class='fa fa-arrow-right'></i> </button> </h3> 
</form>
</div>
<hr>
</div>
...
<form method='post' target='ajax_frame' action='${pageContext.request.contextPath}/shared/upload' name='asset_form' enctype='multipart/form-data'> 
 ...
 <div class='col-md-3 '> 
	<div class='loading-asset'> 
	<div class='loading-asset-inner' onclick='select_asset(${asset.getId()})'> 
	<div class='loading-asset-loading'> 
	 <img  class='img-preview img-responsive img-thumbnail' id='${asset.getId()}' src='${pageContext.request.contextPath}/shared/serve_image/${asset.getId()}'/>
	  <input type='text' id='asset_id' onclick='select_asset(this)' value='${asset.getId()}' class='transparent-file'> 
	 </div> 
	</div> 
	</div>  
	 </div>
