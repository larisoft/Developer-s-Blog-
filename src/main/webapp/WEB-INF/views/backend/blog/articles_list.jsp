...
<div style='float:right; margin-bottom:10px;'>
 <a class='my-links' href='${pageContext.request.contextPath}/blog/new_article'><i class='fa fa-plus'></i> New Article </a> 
</div>
 </div>	
...
<tr> <td> <%=counter++%> </td> <td><c:out value="${article.getTitle()}"/> </td> <td> ${article.getViews()} </td>  <td> 
      <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class='fa fa-bars'></i>  </a>
                    <ul class="dropdown-menu alert-dropdown"> 
                        	
                         <li>
                            <a href="${pageContext.request.contextPath}/blog/view_article/${article.getId()}"><span class="label label-success">View</span></a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/blog/edit_article/${article.getId()}"><span class="label label-warning">Edit</span></a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/blog/delete_article/${article.getId()}"><span class="label label-danger">Delete</span></a>
                        </li> 
                    </ul>
                </li>
</tds></tr>
