...
<div class="container">
  <div class="row">
   ...
   <div class='row'>
   <div class='section-head'> <p class='section-title col-md-offset-2'> ${items_label}</p></div>     
   </div>
   <c:forEach items="${contents}" var="content"> 
      ...
      <c:when test="${has_more}">
       ...
       <a href="${pageContext.request.contextPath}/${module}/${index}"  class="btn pull-right btn-primary">More ${items_label} <i class="glyphicon glyphicon-chevron-right"></i> </a>
       </div>
      </c:when> 
       
      <c:otherwise>
       <div class='row' style='margin:10px;'>
       <a href="#"  class="btn pull-right disabled" disabled>More ${items_label} <i class="glyphicon glyphicon-chevron-right"></i> </a>
       </div>
      </c:otherwise> 
      </c:choose>
